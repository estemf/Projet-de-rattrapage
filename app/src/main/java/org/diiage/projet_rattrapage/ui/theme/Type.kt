...
/**
 * Typographie principale de l'application
 * 
 * Utilise les polices système pour garantir la compatibilité
 * et les performances optimales sur tous les appareils Android.
 */
